...
public:
  ...
  virtual void set_member_offset(unsigned index, unsigned storage_offset);
...
public:
  ...
  void set_storage_offset(unsigned int storage_offset)
  {
    m_storage_offset = storage_offset;
  };
  unsigned get_storage_offset() const
  {
